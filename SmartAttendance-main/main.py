...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        b1.place(x=300,y=100,width =220,height=200)
        ...
        b1_txt.place(x=300,y=260,width =220,height=40)
        ...
        b1.place(x=300,y=350,width =220,height=200)
        ...
        b1_txt.place(x=300,y=510,width =220,height=40)
