...
########################################  face recognition  #################3
    ...
    def recognize_attendence(self):
        ...
        recognizer.read('SmartAttendance-main/.classifier.xml')
        ...
        while True:
            ...
            for(x, y, w, h) in faces:
                ...
                conn=mysql.connector.connect(host='localhost',user='root',password='12345678',database='face_recognition',auth_plugin='mysql_native_password')
                my_cursor=conn.cursor()
                #conn=pymysql.connect(host='localhost',user='root',password='12345678',database='face_recognition')
               # my_cursor=conn.cursor()
