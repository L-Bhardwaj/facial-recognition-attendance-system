...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        # img2=Image.open("SmartAttendance-main/Images/face_rec_1.jpg")
        ...
        title_lb=Label(bg_image,text="Mark your Attendance",font=("PT Serif",35,"bold"),bg="#faffc7",fg="#f7520f")
        title_lb.place(x=-2,y=0,width=1600,height=50)
        ...
        b1.place(x=300,y=230,width =220,height=200)
        ...
        b1_txt.place(x=300,y=390,width =220,height=40)
        ...
        b1.place(x=900,y=230,width =220,height=200)
        ...
        b1_txt.place(x=900,y=390,width =220,height=40)
...
#############################Function buttons ###################
    ...
    def open_img(self):
        os.startfile("SmartAttendance-main/data")
